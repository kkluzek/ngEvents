...
export class SessionListComponent implements OnChanges{
    ...
    constructor(private auth: AuthService, private  voterService: VoteService){}
    ...
    filterSession(filter){
        if (filter === 'all'){
            ...
            this.visibleSession = this.sessions.filter( session => session.level.toLocaleLowerCase() === filter)
        }
    }
}
