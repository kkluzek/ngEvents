...
var VoteService = (function () {
    ...
    VoteService.prototype.deleteVoter = function (session, voterName) {
        session.voters = session.voters.filter(function (voter) { return voter !== voterName; });
    };
    VoteService.prototype.addVoter = function (session, voterName) {
        session.voters.push(voterName);
    };
    VoteService.prototype.userHasVoted = function (session, voterName) {
